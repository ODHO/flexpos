			   ...
			   preg_match('/^[0-9.]+$/', $_POST["newBuyingPrice"])){
				...
				if($answer == "ok"){
					...
					echo'<script>
						...
						swal({
							  type: "success",
							  title: "The service has been added successfully",
				...
				echo'<script>
					...
					swal({
						  type: "error",
						  title: "The service cannot go with empty fields or carry special characters!",
						  showConfirmButton: true,
						  confirmButtonText: "Close"
						  }).then(function(result){
							if (result.value) {
			   ...
			   preg_match('/^[0-9.]+$/', $_POST["editBuyingPrice"]) 
				...
				if($answer == "ok"){
					...
					echo'<script>
						...
						swal({
							  type: "success",
							  title: "The service has been updated",
							  showConfirmButton: true,
							  confirmButtonText: "Close"
							  }).then(function(result){
										if (result.value) {
				...
				echo'<script>
					...
					swal({
						  type: "error",
						  title: "The service cannot be empty or have special characters!",
						  showConfirmButton: true,
						  confirmButtonText: "Close"
						  }).then(function(result){
							if (result.value) {
	...
	static public function ctrDeleteProduct(){
		...
		if(isset($_GET["idProduct"])){
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "The service has been successfully deleted",
					  showConfirmButton: true,
					  confirmButtonText: "Close"
					  }).then(function(result){
								if (result.value) {
